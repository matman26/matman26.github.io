...
![Read-only Automation with Expect](images/expect-read-only.png)
...
![Read-Write Automation with Expect](images/read-write-expect-automation.png)
...
![Idempotence via Parsing](images/idempotent-automation.png)
...
![Plant to be Controlled](images/control-system-plant.png)
...
![Controlling Room Temperature](images/feedback-ac-controller.png)
...
![Closed-Loop Controller](images/intent-based-controller.png)
